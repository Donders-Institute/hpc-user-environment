...
cat $1 | while read l; do
    echo -n "submitting rsync job for $l ... "
    src=$(echo $l | sed 's|^/home[^/]*/|/home_atreides/|')
    dst=$(echo $l | sed 's|^/home[^/]*/|/home/|')
    echo "$dir/rsync.sh '$src' '$dst'" | qsub -N $(basename $l) ${qsub_args} 
done
